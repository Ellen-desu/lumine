...
/// Handler: Homepage
async fn index_handler(_req: Request) -> impl IntoResponse {
    "Welcome to Lumine! 🔥\n\nThis is the homepage."
}

/// Handler: About page
async fn about_handler(_req: Request) -> impl IntoResponse {
    "About Lumine:\n\nLumine is a simple & asynchronous HTTP web server written in Rust.\n\
     Design: Fast & Easy"
}
...
async fn api_status_handler(_req: Request) -> impl IntoResponse {
    (
        StatusCode::OK,
        "{\n  \"status\": \"online\",\n  \"version\": \"0.1.0\",\n  \"uptime\": \"100%\"\n}",
    )
...
async fn api_version_handler(_req: Request) -> impl IntoResponse {
    (
        StatusCode::OK,
        "{\n  \"api_version\": \"1.0.0\",\n  \"release\": \"2024-01-01\"\n}",
    )
